...
@keyframes progress-loop {
    0% {
        stroke-dasharray: 795; /* Prázdný kruh */
        stroke-dashoffset: 796; /* Počáteční bod */
    }
    25% {
        stroke-dasharray: 795; /* Bude se plnit */
        stroke-dashoffset: 400; /* Částečně zaplněný bod */
    }
    50% {
        stroke-dasharray: 795; /* Plný kruh */
        stroke-dashoffset: -5; /* Kompletní plnění */
    }
    75% {
        stroke-dasharray: 795; /* Počíná mizet */
        stroke-dashoffset: -400; /* Poloviční mazání */
    }
    100% {
        stroke-dasharray: 795; /* Prázdný kruh */
        stroke-dashoffset: -798; /* Dokončeno – pokračuje správným směrem */
    }
}
</style>
