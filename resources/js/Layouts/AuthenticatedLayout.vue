...
<template>
    ...
    <div>
        <div>
            ...
            <FlashNotification
                v-if="usePage().props.flash && usePage().props.flash.success"
                :message="usePage().props.flash.success"
            />
            <FlashNotification
                v-if="usePage().props.flash && usePage().props.flash.error"
                :message="usePage().props.flash.error"
            />
            <!-- Pokud chceš debug errors -->
                        ...
                        <div class="flex">
                            ...
                            <div class="flex shrink-0 items-center">
                                <Link :href="route('dashboard')">
                                    <ApplicationLogo
                                        style="width: 80px"
                                        class="block h-auto fill-current text-gray-800"
                                    />
                                </Link>
                            </div>
                            <!-- Navigation Links -->
